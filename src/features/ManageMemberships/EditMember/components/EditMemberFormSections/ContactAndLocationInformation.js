...
const ContactAndLocationInformation = ({
  ...
  return (
    <div className=" my-2">
      <DoctTypography
        variant="h6"
        className="contact_location_info_title_border p-3 text-grey-500 bg-white"
      >
        Contact &#38; Location Information
      </DoctTypography>
      <div className="d-flex justify-content-center pt-5 bg-grey-100 mobile_whtsapp_number_section_edit">
      ...
      <div className="contact_location_info_contents bg-grey-100 d-flex align-items-center justify-content-center">
