      ...
      <div className="d-flex flex-column flex-md-row justify-content-around align-items-center">
        ...
        <div className="d-flex flex-column">
            ...
            <div className="d-flex align-items-center ">
              ...
              <div className="mx-3">
                ...
                <p className="text-primary-500">
                  CEO, BT Savani Kidney Hospital
                </p>
              </div>
            </div>

            <h6 className="text-primary-500 my-3 font-weight-bold">
              Efficient and Smooth
            </h6>
            <p className="testimonial_content ">
              In my short time working with Docthub's Talent Acquisition
              Services on x3 essentials nursing posts, they have really aided us
              with their knowledge in candidate screening and conducting
              interviews in a transparent and timely manner. I look forward to
              working with them again on feature roles; they're one of the best
              Hospital Recruitment agencies
            </p>
          </div>
          ...
          <div className="testimonial_card_body_2 p-3 m-3">
            ...
            <p className="testimonial_content">
              Just a phone call to Docthub's Talent Acquisition Services, and I
              was provided with multiple hospital vacancies! They assisted me in
              selecting the one that best matched my talents and interests. They
              are responsive, responsible, and reliable.
            </p>
          </div>
        </div>
      </div>
